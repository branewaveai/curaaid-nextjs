...
// Define the prop types for the CountrySelect component
interface CountrySelectProps {
  selectedOption: CountryType | null;
  setSelectedOption: (option: CountryType | null) => void;
  setFormData: (data: FormData) => void;
  formData: FormData;
}

const CountrySelect: React.FC<CountrySelectProps>  = React.memo(
  ({ selectedOption, setSelectedOption, setFormData, formData }) => {
    const countryOptions = useMemo(() => countries, []);
    const handleCountryChange = useCallback(
      (event: React.ChangeEvent<{}>, value: CountryType | null) => {
        setFormData({
          ...formData,
      ...
      [formData, setFormData, setSelectedOption]
    );
...
const EnquiryForm: React.FC = () => {
  ...
  const [selectedOption, setSelectedOption] = useState<CountryType | null>(null);
